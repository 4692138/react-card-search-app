        ...
        return (
            <div className="App">
                ...
                <section className='section'>
                    <div className='container'>
                        <div>
                            <div className="field is-grouped" style={{alignItems: "center", paddingBottom:"50px"}}>
                                ...
                                <div className='control' style={{minWidth: "300px"}}>
                                    ...
                                    }} style={{width: "100%", padding: "10px", borderRadius:"5px", border:"1px solid #ccc"}} placeholder='Filter by' type='text'/>
                                </div>
                            </div>
                        </div>
